        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-6">
            <div className="flex items-center space-x-3">
              <Link href="/projects" className="text-gray-400 hover:text-gray-600 transition-colors duration-200">
                <ArrowLeft className="h-6 w-6" />
              </Link>
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Create New Project</h1>
                <p className="mt-1 text-sm text-gray-600">Set up a new agricultural project to manage farms and track progress.</p>
              </div>
            </div>
          </div>
